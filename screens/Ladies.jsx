...
const Ladies = () => {
  ...
  async function getLadies() {
    const ladiesRef = collection(db, "Cloths");
    getDocs(ladiesRef)
      .then(response => {
        ...
        const ladiesCloth = ct.filter(item => item.data.select == "ladies")
        const availableCloth = ladiesCloth.filter(item => item.data.quantity > 0)
  ...
  return (
    <div>
      ...
      <div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="images\ladies\pexels-pixabay-458766.jpg" className="d-block w-100" alt="Sunset Over the City" />
      ...
      <h2 className={"bg-primary text-white text-center p-3"}>Ladies Fashion</h2>
